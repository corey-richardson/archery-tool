...
const options = {
  ...
  apis: ['./src/app/api/**/*.ts'], // This will work during build time
};
...
// Write the spec to public/swagger.json
fs.writeFileSync(
  path.join(publicDir, 'swagger.json'),
  JSON.stringify(spec, null, 2)
);

console.log('✅ Generated swagger.json with', Object.keys(spec.paths || {}).length, 'API routes');